...
def AngularResolutionFromFile(input_energy=None, input_angle=None, energyanglefile=None, aresfile="AResTest.txt", doPlot=False, listResults=False): 
	"""
...
def EnergyResolutionFromFile(input_energy=None, energyfile=None, filename="EResTest.txt", doPlot=False, listResults=False):
	"""
